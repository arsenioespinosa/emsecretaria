var SalasEditView = Backbone.View.extend({ 
   initialize: function(){ 
       //this.render(); 
   ...
   render: function(){ 
    ...
    this.$('#editinputidSala').val(this.model.get('idSala')).textinput('refresh'); 
   ...
   events:{ 
     ...
     //}, 
     'change #editinputidSala': function(){ 
       this.model.set('idSala', this.$('#editinputidSala').val()); 
     }, 
